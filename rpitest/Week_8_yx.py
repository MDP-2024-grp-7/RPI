...
class RaspberryPi:
    ...
    def recv_stm(self) -> None:
        ...
        while True:
            ...
            print("message receive from stm:", message)
    ...
    def command_follower(self) -> None:
        ...
        while True:
            ...
            print("command_follower_command: ", command)
            ...
            stm32_prefixes = ("FS", "BS", "FW", "BW", "FL", "FR", "BL","BR", "TL", "TR", "A", "C", "DT", "STOP", "ZZ", "RS")
    ...
    #     commands = ["FW10", "FR00"] #result['commands']
    #     # path = result['path']

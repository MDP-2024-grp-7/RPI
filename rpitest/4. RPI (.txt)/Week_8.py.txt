...
class RaspberryPi:
            ...
            ## Command: Start Moving ##
                ...
                if message['value'] == "start":
                    ...
                    if not self.command_queue.empty():
                        ...
                        self.unpause.set()
                        #while self.command_queue.empty() == False:
                                #c = self.command_queue.get()
                                #self.stm_link.send(c)
                        self.logger.info(
                        ...
                        self.logger.info(
                            "FW command received, starting robot on path!")
    ...
    def recv_stm(self) -> None:
        ...
        while True:
            ...
            message: str = self.stm_link.recv().strip()
            print(message)
            en = bytes(message, 'UTF-8')
            print(en)
            for b in en:
                print(b, end='')
            print(message == "ACK")
    ...
    def snap_and_rec(self, obstacle_id_with_signal: str) -> None:
        ...
        while True:
            ...
            #results = json.loads("{\"obstacle_id\": 2, \"image_id\": 14}")
